...
#wget -O test_data.zip https://github.com/PGB-LIV/tameNMR-PhenoMeNal/raw/master/test/test_data.zip
...
Rscript SliceSpectra.R --input=test_data/inputdata.tsv --output=test_outputs/out_slice.csv --retainPpm=4-1 --remWater=Y
...
Rscript Normalise.R --input=test_data/inputdata.tsv --output=test_outputs/out_norm_PQN.csv --type=PQN
if ! diff test_outputs/out_slice.csv test_data/out_slice.csv; then
  echo "UNEXPECTED DIFFERENCES IN OUTPUT FILE" >&2
  echo "Test failed" >&2
  exit 1
...
Rscript Normalise.R --input=test_data/inputdata.tsv --output=test_outputs/out_norm_totArea.csv --type=totInt
...
Rscript Normalise.R --input=test_data/inputdata.tsv --output=test_outputs/out_norm_refPeak.csv --type=refPeak --param=0.32-0.33
...
Rscript PeakPick.R --input=test_data/out_slice_norm.csv --output=test_outputs/out_peaks.csv
...
Rscript Align.R --inData=test_data/out_slice_norm.csv --inPeaks=test_data/out_peaks.csv --output=test_outputs/out_aligned.csv
...
Rscript GlobalAlign.R --input=test_data/out_norm_PQN.csv --output=test_outputs/out_aligned_global.csv
...
Rscript prepPattern.R --method=uniform --dataSet=test_data/out_norm_PQN.csv --output=test_outputs/bins_uniform.csv --binSize=0.05
...
Rscript prepPattern.R --method=brukerPattern --pattern=test_data/Bruker_pattern.txt --output=test_outputs/bins_bruker.csv
...
Rscript prepPattern.R --method=csvTable --pattern=test_data/customPattern.csv --output=test_outputs/bins_fromcsv.csv
...
Rscript BinSpectra.R --input=test_data/out_norm_PQN.csv --output=test_outputs/out_binned_uniform.csv --pattern=test_data/bins_uniform.csv
...
Rscript Scaling.R --input=test_data/out_binned_uniform.csv --output=test_outputs/scaled_data_auto.csv --method=auto
...
Rscript Scaling.R --input=test_data/out_binned_uniform.csv --output=test_outputs/scaled_data_pareto.csv --method=pareto
...
Rscript Scaling.R --input=test_data/out_binned_uniform.csv --output=test_outputs/scaled_data_range.csv --method=range
...
Rscript Scaling.R --input=test_data/out_binned_uniform.csv --output=test_outputs/scaled_data_mean.csv --method=mean
...
Rscript transform.R --input=test_data/out_binned_uniform_pos.csv --output=test_outputs/trans_data_log.csv --method=log
...
Rscript transform.R --input=test_data/out_binned_uniform_pos.csv --output=test_outputs/trans_data_sqrt.csv --method=sqrt
...
Rscript Ttest.R --input=test_data/out_binned_uniform.csv --output=test_outputs/ttest_out.html --outdir=test_outputs/ttest_out --factorFile=test_data/fact_small.txt --factorCol=1 --tails=two.sided --paired=N --conf_level=0.05
...
Rscript Anova.R --input=test_data/out_binned_uniform.csv --output=test_outputs/anova_out.html --outdir=test_outputs/anova_out --factorFile=test_data/fact_small.txt --factorCol=2 --conf_level=0.05 --adjust=BH
...
Rscript PCA.R --input=test_data/out_binned_uniform.csv --output=test_outputs/pca_out.html --outdir=test_outputs/pca_out --factorFile=test_data/fact_small.txt --factorCol=2 --pcs="1-2,1-3" --scale=Y --showScores=Y --showLoadings=Y --showVarAcc=Y
...
Rscript PLSDA.R --input=test_data/out_binned_uniform.csv --output=test_outputs/plsda_out.html --outDir=test_outputs/plsda_out --factorFile=test_data/fact_small.txt --factorCol=2
...
Rscript PlotNMR.R --input=test_data/inputdata.tsv --output=test_outputs/out_spectra_plots.html --outDir=test_outputs/out_spectra_plots --ppmInt=3-2 --spread=N
...
Rscript PlotNMRSig.R --input=test_data/inputdata.tsv --output=test_outputs/out_sig_plots.html --outDir=test_outputs/out_sig_plots --ppmInt=4-2 --bins=test_data/bins_uniform.csv --pvals=test_data/pvals --colourbar=discrete
...
Rscript QuantilePlot.R --input=test_data/inputdata.tsv --output=test_outputs/out_quantile_plots.html --outDir=test_outputs/out_quantile_plots --ppmInt=3-2 --pltMean=Y
